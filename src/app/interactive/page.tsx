  ...
  return (
    <div className="relative bg-interactive overflow-hidden">
      ...
      <div className="py-section px-container flex flex-col items-center gap-3xl">
        ...
        <div className="self-stretch flex justify-evenly items-center">
