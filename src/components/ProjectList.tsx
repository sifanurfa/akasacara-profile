...
const projects = [
  { title: "Gowok", year: 2020, img: "https://placehold.co/412x618" },
  { title: "Darah Nyai", year: 2020, img: "https://placehold.co/412x618" },
  { title: "Berproses Meraih Sukses ", year: 2020, img: "https://placehold.co/412x618" },
  { title: "Serigala Langit", year: 2020, img: "https://placehold.co/412x618" },
  { title: "KLHK", year: 2020, img: "https://placehold.co/412x618" },
  { title: "Tour DTEDI", year: 2020, img: "https://placehold.co/412x618" },
  { title: "Tengkorak", year: 2020, img: "https://placehold.co/412x618" },
];
        ...
        {projects.map((p, index) => (
          ...
          >
            <div className="flex justify-center items-start ">
              <div className="flex flex-col items-start gap-[10px] vfx-text-subtitle-2 headline-2 group-hover:!text-white transition-colors duration-300 ">
                {p.title}
              </div>
            </div>
